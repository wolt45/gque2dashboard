 ...
 */
 (function (window, angular, undefined) {
    ...
    angular
      .module("a8m.group-by", ["a8m.filter-watcher"])
    ...
    angular
      .module("a8m.math.byteFmt", ["a8m.math"])
          ...
          return function (bytes, decimal) {
            if (
              ...
              if (bytes < 1024) {
                ...
                // GB or more
                return (
                  convertToDecimal(bytes / 1073741824, decimal, $math) + " GB"
                );
              }
            } else {
              return "NaN";
    ...
    angular
      .module("a8m.math.degrees", ["a8m.math"])
        ...
        function ($math) {
          return function (radians, decimal) {
            ...
            if (
              ...
              return (
                $math.round(degrees * $math.pow(10, decimal)) /
                $math.pow(10, decimal)
              );
            } else {
              return "NaN";
    ...
    angular
      .module("a8m.math.kbFmt", ["a8m.math"])
    ...
    angular
      .module("a8m.math.percent", ["a8m.math"])
    ...
    angular
      .module("a8m.math.radians", ["a8m.math"])
        ...
        function ($math) {
          return function (degrees, decimal) {
            ...
            if (
              ...
              return (
                $math.round(radians * $math.pow(10, decimal)) /
                $math.pow(10, decimal)
              );
            } else {
              return "NaN";
    ...
    angular
      .module("a8m.math.shortFmt", ["a8m.math"])
     ...
     *
     */
    angular.module("a8m.ucfirst", []).filter("ucfirst", [
      function () {
        return function (input) {
          if (!isString(input)) {
            return input;
    ...
    angular
      .module("a8m.uri-component-encode", [])
        ...
        this.$get = [
          ...
          function ($window, $rootScope) {
            ...
            function getHashKey(fName, args) {
              return [fName, angular.toJson(args)].join("#").replace(/"/g, "");
            }
