    ...
    for (o = t.length - 1; 0 <= o; --o) {
      ...
      if ("$" !== c.charAt(0))
        if ("options" === c) s.push(...this._animateOptions(e, i));
          ...
          h && h.duration
            ? ((n[c] = t = new Animation(h, e, c, l)), s.push(t))
            : (e[c] = l);
        }
    }
    return s;
...
function updateStacks(t, e) {
  ...
  for (let t = 0; t < c; ++t) {
    ...
    const f = p._stacks || (p._stacks = {}),
      m =
        (((d = f[l] = getOrCreateStack(s, h, u))[r] = g),
        (d._top = getLastIndexInStack(d, n, !0, a.type)),
        (d._bottom = getLastIndexInStack(d, n, !1, a.type)),
        d._visualValues || (d._visualValues = {}));
    m[r] = g;
  }
}
...
class DatasetController {
  ...
  parsePrimitiveData(t, e, i, a) {
    ...
    for (d = 0, u = a; d < u; ++d)
      (g = d + i),
        (c[d] = { [r]: h || s.parse(l[g], g), [o]: n.parse(e[g], g) });
    return c;
  }
  parseArrayData(t, e, i, a) {
    ...
    for (o = 0, l = a; o < l; ++o)
      (c = e[(h = o + i)]),
        (r[o] = { x: s.parse(c[0], h), y: n.parse(c[1], h) });
    return r;
  }
  ...
  getMinMax(e, t) {
    ...
    for (
      d = 0;
      d < n && (g() || (this.updateRangeFromParsed(l, e, u, o), !s));
      ++d
    );
    if (s)
      for (d = n - 1; 0 <= d; --d)
  ...
  _resolveElementOptions(t, e = "default", i) {
    ...
    return (
      c.$shared &&
        ((c.$shared = o), (s[n] = Object.freeze(cloneIfNotShared(c, o)))),
      c
    );
  }
...
class BarController extends DatasetController {
  ...
  parseObjectData(t, e, i, a) {
    ...
    for (d = (c = i) + a; c < d; ++c)
      (g = e[c]),
        ((u = {})[s.axis] = s.parse(resolveObjectKey(g, o), c)),
        h.push(parseValue(resolveObjectKey(g, l), u, n, c));
    return h;
  }
  updateRangeFromParsed(t, e, i, a) {
  ...
  updateElements(e, i, a, s) {
    ...
    for (let t = i; t < i + a; t++) {
      ...
      u &&
        (v.options =
          d || this.resolveDataElementOptions(t, e[t].active ? "active" : s));
      g = v.options || e[t].options;
      setBorderSkipped(v, g, m, r),
        setInflateAmount(v, g, c.ratio),
  ...
  _calculateBarValuePixels(t) {
    ...
    u !== c && ((d = u - c), (u = c)),
      h &&
        ...
        0 !== c && sign(c) !== sign(l.barEnd) && (d = 0),
        (d += c));
    var f,
      l = isNullOrUndef(s) || h ? d : s;
    let m = e.getPixelForValue(l);
    return (
      (g = this.chart.getDataVisibility(t) ? e.getPixelForValue(d + u) : m),
      (p = g - m),
      Math.abs(p) < n &&
        ((p = barSign(p, e, r) * n),
        c === r && (m -= p / 2),
...
class BubbleController extends DatasetController {
  ...
  updateElements(e, i, a, s) {
    ...
    for (let t = i; t < i + a; t++) {
      ...
      const f = {};
      var p = (f[c] = n ? r.getPixelForDecimal(0.5) : r.getPixelForValue(g[c])),
...
class DoughnutController extends DatasetController {
  ...
  updateElements(t, e, i, a) {
    ...
    for (p = e; p < e + i; ++p) {
      ...
      u &&
        (v.options =
          d || this.resolveDataElementOptions(p, m.active ? "active" : a)),
        (g += f),
...
class LineController extends DatasetController {
  ...
  updateElements(e, i, t, a) {
    ...
    var { sharedOptions: h, includeOptions: c } = this._getSharedOptions(i, a),
      d = n.axis,
      u = r.axis,
    ...
    for (let t = 0; t < x; ++t) {
      ...
      t < i || t >= v
        ...
        : ((_ = this.getParsed(t)),
          (y = isNullOrUndef(_[u])),
          (k = D[d] = n.getPixelForValue(_[d], t)),
          (S = D[u] =
            s || y
              ? r.getBasePixel()
              : r.getPixelForValue(o ? this.applyStack(r, _, o) : _[u], t)),
          (D.skip = isNaN(k) || isNaN(S) || y),
          (D.stop = 0 < t && Math.abs(_[d] - b[d]) > f),
          p && ((D.parsed = _), (D.raw = l.data[t])),
          c &&
            (D.options =
              h || this.resolveDataElementOptions(t, M.active ? "active" : a)),
          m || this.updateElement(M, t, D, a),
          (b = _));
    }
  }
  getMaxOverflow() {
  ...
  updateElements(e, i, a, s) {
    ...
    for (let t = i; t < i + a; ++t) {
      ...
      (M.skip = isNaN(k) || isNaN(S) || y),
        (M.stop = 0 < t && Math.abs(_[u] - x[u]) > m),
        f && ((M.parsed = _), (M.raw = h.data[t])),
        d &&
          (M.options =
            c || this.resolveDataElementOptions(t, b.active ? "active" : s)),
        v || this.updateElement(b, t, M, s),
        (x = _);
    }
...
function evaluateInteractionItems(t, i, e, a, s) {
  ...
  for (let t = 0, e = n.length; t < e; ++t) {
    var { index: o, data: l } = n[t],
      { lo: h, hi: c } = binarySearch(n[t], i, r, s);
    for (let t = h; t <= c; ++t) {
      var d = l[t];
      d.skip || a(d, o, t);
    }
    ...
    evaluateInteractionItems(n, t, r, function (t, e, i) {
      ...
      (o && !s) ||
        ...
        (h || n.isPointInArea(a) || s) &&
          ((s = d(r, a)) < u
            ? ((c = [{ element: t, datasetIndex: e, index: i }]), (u = s))
            : s === u && c.push({ element: t, datasetIndex: e, index: i })));
    }),
    c
  );
}
...
var layouts = {
  ...
  update(i, t, e, a) {
    if (i) {
      ...
      fitBoxes(o.fullSize, d, t, h),
        fitBoxes(c, d, t, h),
        fitBoxes(l, d, t, h) && fitBoxes(c, d, t, h),
        handleMaxPadding(d),
        placeBoxes(o.leftAndTop, d, t, h),
        (d.x += d.w),
        (d.y += d.h),
        placeBoxes(o.rightAndBottom, d, t, h),
        (i.chartArea = {
          left: d.left,
          top: d.top,
          right: d.left + d.w,
        ...
        each(o.chartArea, (t) => {
          ...
          Object.assign(e, i.chartArea),
            e.update(d.w, d.h, { left: 0, top: 0, right: 0, bottom: 0 });
        });
    }
  },
};
...
function skip(t, e, i, a, s) {
  ...
  let o = 0,
    ...
    c;
  for (
    i = Math.ceil(i), s && (i = (l = s - a) / Math.floor(l / i)), c = n;
    c < 0;

  )
    o++, (c = Math.round(n + o * i));
  for (h = Math.max(n, 0); h < r; h++)
    h === c && (e.push(t[h]), o++, (c = Math.round(n + o * i)));
}
  ...
  return (
    t.isHorizontal()
      ? ((g = _alignStartEnd(a, n, o)),
        (p = isObject(i)
          ? ((m = i[(f = Object.keys(i)[0])]), c[f].getPixelForValue(m) + l - e)
          : "center" === i
          ? (h.bottom + h.top) / 2 + l - e
          : offsetFromEdge(t, i, e)),
        (u = o - n))
      : ((g = isObject(i)
          ? ((m = i[(f = Object.keys(i)[0])]), c[f].getPixelForValue(m) - v + e)
          : "center" === i
          ? (h.left + h.right) / 2 - v + e
          : offsetFromEdge(t, i, e)),
        (p = _alignStartEnd(a, r, s)),
        (d = "left" === i ? -HALF_PI : HALF_PI)),
    { titleX: g, titleY: p, maxWidth: u, rotation: d }
  );
}
class Scale extends Element {
  ...
  fit() {
    ...
    var e,
      ...
      d = this.isHorizontal();
    c &&
      ((c = getTitleHeight(l, r.options.font)),
      d
        ? ((t.width = this.maxWidth), (t.height = getTickMarkLength(h) + c))
        : ((t.height = this.maxHeight), (t.width = getTickMarkLength(h) + c)),
      o.display &&
        this.ticks.length &&
        (({ first: l, last: h, widest: c, highest: e } = this._getLabelSizes()),
        (i = 2 * o.padding),
        (s = toRadians(this.labelRotation)),
        (a = Math.cos(s)),
        (s = Math.sin(s)),
        d
          ? ((n = o.mirror ? 0 : s * c.width + a * e.height),
            (t.height = Math.min(this.maxHeight, t.height + n + i)))
          : ((n = o.mirror ? 0 : a * c.width + s * e.height),
    ...
    if (this.isHorizontal()) {
      ...
      h
        ...
        (this.paddingLeft = Math.max(
          ((t - c + o) * this.width) / (this.width - c),
          0
        )),
        (this.paddingRight = Math.max(
          ((e - d + o) * this.width) / (this.width - d),
          0
        ));
    } else {
      let t = a.height / 2,
  ...
  _computeLabelItems(t) {
    ...
    let f,
      ...
      P = "middle";
    "top" === a
      ? ((b = this.bottom - c), (_ = this._getXAxisLabelAlignment()))
      : "bottom" === a
      ? ((b = this.top + c), (_ = this._getXAxisLabelAlignment()))
      : "left" === a
      ? ((c = this._getYAxisLabelAlignment(i)), (_ = c.textAlign), (x = c.x))
      : "right" === a
      ? ((c = this._getYAxisLabelAlignment(i)), (_ = c.textAlign), (x = c.x))
      : "x" === e
      ? ("center" === a
          ...
          : isObject(a) &&
            ((n = a[(c = Object.keys(a)[0])]),
            (b = this.chart.scales[c].getPixelForValue(n) + u)),
      ...
      : "y" === e &&
        ("center" === a
          ...
          : isObject(a) &&
            ((n = a[(c = Object.keys(a)[0])]),
            (x = this.chart.scales[c].getPixelForValue(n))),
          ...
          (D =
            "top" === a
              ? "near" === h || 0 != g
                ? -M * S + S / 2
                : "center" === h
                ? -w.highest.height / 2 - A * S + S
                : -w.highest.height + S / 2
              : "near" === h || 0 != g
              ? S / 2
              : "center" === h
              ? w.highest.height / 2 - A * S
              : w.highest.height - M * S),
          d && (D *= -1),
          0 == g || C.showLabelBackdrop || (x += (S / 2) * Math.sin(g)))
        : ((b = y), (D = ((1 - M) * S) / 2));
      let i;
...
function determineAxis(t, e) {
  ...
  if (
    (t =
      e.axis ||
      axisFromPosition(e.position) ||
      (1 < t.length && determineAxis(t[0].toLowerCase(), e)))
  )
    return t;
  throw new Error(
...
function pathArc(t, e, i, a, s, n) {
  var { x: r, y: o, startAngle: l, pixelMargin: h, innerRadius: c } = e,
    d = Math.max(e.outerRadius + a + i - h, 0),
    h = 0 < c ? c + a + i + h : 0;
  let u = 0;
  var g = s - l,
    c =
      (a &&
        ((c = ((0 < c ? c - a : 0) + (0 < d ? d - a : 0)) / 2),
        (u = (g - (0 != c ? (g * c) / (c + a) : g)) / 2)),
      Math.max(0.001, g * d - i / PI) / d),
    a = (g - c) / 2,
    i = l + a + u,
    g = s - a - u,
    {
  ...
  t.beginPath(),
    n
      ? (t.arc(r, o, d, f, (n = (f + m) / 2)),
        ...
        t.lineTo(x.x, x.y),
        0 < c &&
          ((n = rThetaToXY(e, f, r, o)), t.arc(n.x, n.y, c, i - HALF_PI, f)))
      : (t.moveTo(r, o),
        (_ = Math.cos(f) * d + r),
        (g = Math.sin(f) * d + o),
        t.lineTo(_, g),
...
function drawBorder(e, i, a, s, n) {
  ...
  if (c) {
    h
      ? ((e.lineWidth = 2 * c), (e.lineJoin = d || "round"))
      : ((e.lineWidth = c), (e.lineJoin = d || "bevel"));
    let t = i.endAngle;
    if (r) {
      pathArc(e, i, a, s, t, n);
...
function pathSegment(t, e, i, a) {
  ...
  let { move: c = !0, reverse: d } = a || {},
    u,
    g,
    p;
  for (u = 0; u <= l; ++u)
    (g = s[(o + (d ? l - u : u)) % r]).skip ||
      (c ? (t.moveTo(g.x, g.y), (c = !1)) : h(t, p, g, d, n.stepped), (p = g));
...
function fastPathSegment(t, e, i, a) {
  ...
  for (l && ((g = s[y(0)]), t.moveTo(g.x, g.y)), u = 0; u <= o; ++u)
    (g = s[y(u)]).skip ||
      ...
      (b = g.y),
      (_ = 0 | x) === p
        ? (b < f ? (f = b) : b > m && (m = b), (c = (d * c + x) / ++d))
        : (k(), t.lineTo(x, b), (p = _), (d = 0), (f = m = b)),
      (v = b));
  k();
}
...
function _segments(t, e, i) {
  ...
  for (const d of a) {
    var { start: o, end: l } = d,
      ...
      h = _getBounds(i, s[o], s[l], d.loop);
    if (e.segments)
      for (const u of _boundSegments(e, h)) {
        var c = _getBounds(i, n[u.start], n[u.end], u.loop);
        for (const g of _boundSegment(d, s, c))
          r.push({
            source: g,
            target: u,
            start: { [i]: _getEdge(h, c, "start", Math.max) },
            end: { [i]: _getEdge(h, c, "end", Math.min) },
          });
      }
...
function fill(e, t) {
  ...
  var o, l, h, c;
  for ({ source: o, target: l, start: h, end: c } of _segments(i, a, s)) {
    var { style: { backgroundColor: d = n } = {} } = o,
      u = !0 !== a,
      d =
        (e.save(),
        (e.fillStyle = d),
        clipBounds(e, r, u && _getBounds(s, h, c)),
        e.beginPath(),
        !!i.pathSegment(e, o));
    let t;
    u &&
      (d ? e.closePath() : interpolatedLineTo(e, a, c, s),
      (u = !!a.pathSegment(e, l, { move: d, reverse: !0 })),
      (t = d && u) || interpolatedLineTo(e, a, h, s)),
      e.closePath(),
...
class Legend extends Element {
  ...
  _draw() {
    ...
    this.drawTitle(),
      ...
      (f.lineWidth = 0.5),
      (f.font = _.string);
    const { boxWidth: D, boxHeight: P, itemHeight: w } = getBoxSize(v, k),
      C = this.isHorizontal(),
    ...
    this.legendItems.forEach((t, e) => {
      ...
      b.setWidth(this.width),
        C
          ? 0 < e &&
            ...
            M.line++,
            (s = M.x =
              _alignStartEnd(m, this.left + y, this.right - p[M.line])))
          : 0 < e &&
            n + O > this.bottom &&
            ((s = M.x = s + g[M.line].width + y),
            M.line++,
            (n = M.y =
              _alignStartEnd(
                m,
                this.top + A + y,
                this.bottom - g[M.line].height
              )));
      var r,
        o,
        l,
      ...
      (e = e),
        ...
        isNaN(D) ||
          ...
          P < 0 ||
          (f.save(),
          (r = valueOrDefault(c.lineWidth, 1)),
          (f.fillStyle = valueOrDefault(c.fillStyle, x)),
          (f.lineCap = valueOrDefault(c.lineCap, "butt")),
          (f.lineDashOffset = valueOrDefault(c.lineDashOffset, 0)),
          (f.lineJoin = valueOrDefault(c.lineJoin, "miter")),
          (f.lineWidth = r),
          (f.strokeStyle = valueOrDefault(c.strokeStyle, x)),
          f.setLineDash(valueOrDefault(c.lineDash, [])),
          v.usePointStyle
            ? ((o = {
              ...
              (l = b.xPlus(e, D / 2)),
              (d = h + S),
              drawPointLegend(f, o, l, d, v.pointStyleWidth && D))
            : ((o = h + Math.max((k - P) / 2, 0)),
              (l = b.leftForLtr(e, D)),
              (d = toTRBLCorners(c.borderRadius)),
              f.beginPath(),
              Object.values(d).some((t) => 0 !== t)
                ? addRoundedRectPath(f, { x: l, y: o, w: D, h: P, radius: d })
                : f.rect(l, o, D, P),
              f.fill(),
              0 !== r && f.stroke()),
          f.restore()),
        (s = _textX(a, s + D + S, C ? s + i : this.right, u.rtl)),
        (h = b.x(s)),
        (e = n),
        (c = t),
        renderText(f, c.text, h, e + w / 2, _, {
        ...
        C
          ...
          ? ((d = _.lineHeight), (M.y += calculateLegendItemHeight(t, d)))
          : (M.y += O);
    }),
  ...
  drawTitle() {
    ...
    if (s.display) {
      ...
      (c.textAlign = h.textAlign(_toLeftRightCenter(o))),
        (c.textBaseline = "middle"),
        (c.strokeStyle = s.color),
        (c.fillStyle = s.color),
        (c.font = n.string),
        renderText(c, s.text, r, t, n);
    }
  }
  _computeTitleHeight() {
...
class Title extends Element {
  ...
  _drawArgs(t) {
    ...
    return (
      (l = this.isHorizontal()
        ? ((h = _alignStartEnd(r, i, s)), (c = e + t), s - i)
        : ((o =
            "left" === n.position
              ? ((h = i + t), (c = _alignStartEnd(r, a, e)), -0.5 * PI)
              : ((h = s - t), (c = _alignStartEnd(r, e, a)), 0.5 * PI)),
          a - e)),
      { titleX: h, titleY: c, maxWidth: l, rotation: o }
    );
  }
  draw() {
    var t,
  ...
  nearest(t, e) {
    ...
    for (n = 0, r = t.length; n < r; ++n) {
      ...
      c &&
        c.hasValue() &&
        ((l = c.getCenterPoint()),
        (l = distanceBetweenPoints(e, l)) < s && ((s = l), (o = c)));
    }
    var h;
    return (
...
function getTooltipSize(t, e) {
  ...
  (v += t.beforeBody.length + t.afterBody.length),
    ...
    v &&
      ((d = e.displayColors ? Math.max(o, l.lineHeight) : l.lineHeight),
      (f += g * d + (v - g) * l.lineHeight + (v - 1) * e.bodySpacing)),
    u &&
      ...
      "center" === s
        ...
        : ((u =
          ...
          (g =
            "top" === s
              ? ((p = h), (f = p - i), (d = u - i), u + i)
              : ((p = h + c), (f = p + i), (d = u + i), u - i)),
          (m = p)),
      { x1: d, x2: u, x3: g, y1: p, y2: f, y3: m }
    );
  }
  drawTitle(t, e, i) {
    var a = this.title,
  ...
  _drawColorBox(t, e, i, a, s) {
    ...
    s.usePointStyle
      ...
      : ((t.lineWidth = isObject(r.borderWidth)
        ...
        (d = a.leftForLtr(u, h - c)),
        (o = a.leftForLtr(a.xPlus(u, 1), h - c - 2)),
    ...
    (d && _ !== n
      ? (i.push({ value: n }),
        ...
        almostEquals(
          ...
          n,
          relativeLabelSize(n, c, t)
        ) && S++)
      : _ < n && S++);
    S < k;
    ++S
  )
    i.push({ value: Math.round((_ + S * x) * b) / b });
  return (
    m && d && y !== r
      ? i.length &&
        almostEquals(i[i.length - 1].value, r, relativeLabelSize(r, c, t))
...
function generateTicks(t, { min: e, max: i }) {
  ...
  let c = Math.floor((s - h) / Math.pow(10, n)),
    d = finiteOrDefault(
      t.min,
      Math.round((l + h + c * Math.pow(10, n)) * r) / r
    );
  for (; d < i; )
    a.push({ value: d, major: isMajor(d), significand: c }),
      10 <= c ? (c = c < 15 ? 15 : 20) : c++,
      20 <= c && (n++, (c = 2), (r = 0 <= n ? 1 : r)),
      (d = Math.round((l + h + c * Math.pow(10, n)) * r) / r);
...
function fitWithPointLabels(e) {
  ...
  for (let t = 0; t < r; t++) {
    ...
    updateLimits(
      ...
      i,
      d,
      determineLimits(u, c.x, h.w, 0, 180),
      determineLimits(u, c.y, h.h, 90, 270)
    );
  }
...
function drawPointLabels(e, i) {
  ...
  for (let t = i - 1; 0 <= t; t--) {
    var n,
      r,
      o,
      l = s.setContext(e.getPointLabelContext(t)),
      h = toFont(l.font),
      {
        x: c,
        y: d,
      ...
      v = l["backdropColor"];
    isNullOrUndef(v) ||
      ((n = toTRBLCorners(l.borderRadius)),
      (r = toPadding(l.backdropPadding)),
      (a.fillStyle = v),
      (v = g - r.left),
      (o = p - r.top),
      (f = f - g + r.width),
      ...
      Object.values(n).some((t) => 0 !== t)
        ? (a.beginPath(),
          addRoundedRectPath(a, { x: v, y: o, w: f, h: g, radius: n }),
          a.fill())
        : a.fillRect(v, o, f, g)),
      renderText(a, e._pointLabels[t], c, d + h.lineHeight / 2, h, {
        color: l.color,
        textAlign: u,
        textBaseline: "middle",
      });
...
class TimeScale extends Scale {
  ...
  _generate() {
    ...
    return (
      (c !== i && "ticks" !== a.bounds && 1 !== d) || addTick(l, c, u),
      Object.keys(l)
        .sort((t, e) => t - e)
        .map((t) => +t)
    );
